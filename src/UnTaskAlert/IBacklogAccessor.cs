...
public interface IBacklogAccessor
{
    ...
    Task<IList<WorkItem>> GetWorkItemsById(VssConnection connection, List<int> workItemsIds, WorkItemExpand expand = WorkItemExpand.Fields);
    ...
    List<int> GetChildTaskIds(VssConnection connection, Microsoft.TeamFoundation.WorkItemTracking.WebApi.Models.WorkItem userStory);
}