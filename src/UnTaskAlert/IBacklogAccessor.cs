...
public interface IBacklogAccessor
{
    ...
    Task<List<int>> GetWorkItemsForPeriod(VssConnection connection, string name, DateTime dateTime,
    ...
    Task<TimeSpan> GetWorkItemActiveTime(VssConnection connection, int taskInfoId);
}